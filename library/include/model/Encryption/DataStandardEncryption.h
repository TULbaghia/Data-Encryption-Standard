#ifndef DES_KRYPTOGRAFIA_DATASTANDARDENCRYPTION_H
#define DES_KRYPTOGRAFIA_DATASTANDARDENCRYPTION_H
...
class DataStandardEncryption : public Encryption {
public:
...
private:
    ...
    const byte shiftsTable[16] = {
            1, 1, 2, 2,
            2, 2, 2, 2,
            1, 2, 2, 2,
            2, 2, 2, 1 };

    const byte keyCompression[48] = {
    ...
    const byte initialPermutation[64] = {
            58, 50, 42, 34, 26, 18, 10, 2,
    ...
    const byte expansionFunction[48] = {
            32,  1,  2,  3,  4,  5,  4,  5,
             6,  7,  8,  9,  8,  9, 10, 11,
    ...
    const byte finalPermutation[64] = {
...
#endif //DES_KRYPTOGRAFIA_DATASTANDARDENCRYPTION_H
